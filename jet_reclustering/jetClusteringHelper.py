...
class InclusiveJetClusteringHelper:
    def __init__(self, coll, jetR, jetPt, tag="", particle_class="ReconstructedParticle"):
        ...
        self.definition[part_px] = particle_class+"::get_px({})".format(self.input_coll)
        self.definition[part_py] = particle_class+"::get_py({})".format(self.input_coll)
        self.definition[part_pz] = particle_class+"::get_pz({})".format(self.input_coll)
        self.definition[part_e] = particle_class+"::get_e({})".format(self.input_coll)
        self.definition[part_m] = particle_class+"::get_mass({})".format(self.input_coll)
        self.definition[part_q] = particle_class+"::get_charge({})".format(self.input_coll)
