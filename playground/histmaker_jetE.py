...
def build_graph(df, dataset):
    ...
    df = df.Define("fancy_matching", "FCCAnalyses::ZHfunctions::get_reco_truth_jet_mapping(JetDurhamN4, GenJetDurhamN4)")
    ...
    df = df.Define("ratio_jet_energies_fancy", "matching_processing.first")
    df = df.Define("E_of_unmatched_reco_jets", "matching_processing.second")
